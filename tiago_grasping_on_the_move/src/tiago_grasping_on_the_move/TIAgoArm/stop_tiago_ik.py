...
class ArmController:
    def __init__(self):
        ...
        self.ee_orientation_r = 1.60 # 1.5
        self.ee_orientation_p = 0.5 # 0.0
        self.ee_orientation_y = 0.0 # 1.5
    ...
    def move_arm(self):
        ...
        transformed_coordinates = self.transform_point(
            np.array([self.eps_t_x - 0.2,self.eps_t_y - 0.2,self.eps_t_z]),  
            from_frame = self.from_frame, 
            to_frame = self.to_frame
        )

        # transformed_coordinates = [self.eps_t_x,self.eps_t_y,self.eps_t_z]
        ...
        # goal_pose.pose.position.x = 0.35 # transformed_coordinates[0] #  0.35 - 0.55
        # goal_pose.pose.position.y = 0.56 #0.53 # transformed_coordinates[1] #  
        # goal_pose.pose.position.z = 0.77 # transformed_coordinates[2] #  
        goal_pose.pose.position.x = transformed_coordinates[0] # 0.55 #0.35 transformed_coordinates[0] #  0.35 - 0.55
        goal_pose.pose.position.y = transformed_coordinates[1] # 0.55 #0.53 # transformed_coordinates[1] #  
        goal_pose.pose.position.z = transformed_coordinates[2] # 0.77 # transformed_coordinates[2] #  
